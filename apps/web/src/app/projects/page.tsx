        ...
        <div className="space-y-3">
          ...
          <div>
            <p className="mb-2 text-xs font-medium text-neutral-400">
              Project memory{ledger.length ? ` (${ledger.length})` : ''}
            </p>
            <LedgerView
              entries={ledger}
              emptyHint="Empty for now - as tasks run, what they do and learn accretes here (compact and deduped), and seeds future agents so they skip redundant work."
            />
          </div>
        </div>
      )}
