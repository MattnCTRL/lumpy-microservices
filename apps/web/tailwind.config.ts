  ...
  theme: {
    extend: {
      ...
      keyframes: {
        ...
        // Transform-only on purpose: the Done-lane drain is driven by an inline
        // `opacity` style, and a `both`-fill animation that also touched opacity
        // would override it and pin cards opaque forever.
        'lane-in': {
